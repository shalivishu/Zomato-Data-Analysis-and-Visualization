...
data = pd.read_csv(r'C:\Users\shali\ML Folder\cleaned_zomato_dataset.csv')
...
def main():
    ...
    image_path = r"C:\Users\shali\Downloads\zomato_image.jpeg"
    ...
    if selected == 'Charts':
        ...
        if selected_country == 'India':
            ...
            chart = px.bar(
                    ...
                    y='Cost in INR', 
                    labels={'x': 'Cuisine', 'y': 'Average Cost for two'},
                    title='Top 10 Costliest Cuisines in India in bar chart',
                    color='Average Cost for two',  # Use 'Average Cost for two' for coloring
